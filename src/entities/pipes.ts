...
export default class Pipes extends Phaser.GameObjects.Group {
    ...
    constructor(scene: Phaser.Scene, x: number) {
        ...
        this.topPipe = new Phaser.GameObjects.Rectangle(scene, 850 + x, this.gapY, 50, 600, 0x1f51bf);
        ...
        this.bottomPipe = new Phaser.GameObjects.Rectangle(scene, 850 + x, this.gapY + this.gapSize, 50, 600, 0x1f51bf);
